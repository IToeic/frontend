...
const WordCard = ({ words, setActiveSubTab, page }) => {
  ...
  return (
    <>
      {/* 단어 카드 */}
      <div className="bg-white rounded-lg shadow-lg p-4 sm:p-8 mb-4 sm:mb-6 select-none">
        {/* 상단 컨트롤 */}
        ...
        {/* 단어 내용 */}
        <div className="text-center mb-6 sm:mb-8 items-center">
          <h2
            className="text-2xl sm:text-4xl font-bold text-gray-800 mb-4 notranslate"
            translate="no"
            lang="en"
          >
            {currentWord.word}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          <button
            ...
            className={`flex items-center space-x-2 px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm sm:text-base ${
          ...
          <button
            ...
            className={`flex items-center justify-center min-w-[80px] sm:min-w-[87px] py-2 px-3 sm:px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm sm:text-base ${
